...
def parse_conllu(conllu_text):
    ...
    Each token dictionary contains fields like 'id', 'form', 'lemma', 'upos', 'head', 'deprel', etc.
    """
    tokens = []
...
def build_graph_from_conllu(conllu_text):
    ...
    # Optionally, perform a cleaning step as in Spacy-based code
    # For example, remove self-loops or filter isolated nodes, etc.
    # This is a placeholder for any cleaning logic you may want to add
    # For now, we keep the graph as-is
    return graph
